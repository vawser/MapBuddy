...
namespace MapBuddy.RegionInfo
{
    internal class InfoOther
    {
        ...
        public InfoOther(string path, Dictionary<string, string> mapDict, bool splitByMap)
        {
        ...
        public void WriteCSV(MSBE msb, string map_name, bool outputByMap)
        {
            ...
            foreach (MSBE.Region.Other entry in msb.Regions.Others)
            {
                string line = "";
