...
namespace MapBuddy.RegionInfo
{
    internal class InfoDummy
    {
        ...
        public InfoDummy(string path, Dictionary<string, string> mapDict, bool splitByMap)
        {
        ...
        public void WriteCSV(MSBE msb, string map_name, bool outputByMap)
        {
            ...
            foreach (MSBE.Region.Dummy entry in msb.Regions.Dummies)
            {
                string line = "";
