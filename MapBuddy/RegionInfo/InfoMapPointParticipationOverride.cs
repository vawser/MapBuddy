...
{
    internal class InfoMapPointParticipationOverride
    {
        Logger logger = new Logger();

        string output_dir = "";
        string header = "";
        string propertyName = "MapPointParticipationOverride";
        string combined_file_name = "";
        string file_format = "csv";

        public InfoMapPointParticipationOverride(string path, Dictionary<string, string> mapDict, bool splitByMap)
        {
        ...
        public void WriteCSV(MSBE msb, string map_name, bool outputByMap)
        {
            ...
            foreach (MSBE.Region.MapPointParticipationOverride entry in msb.Regions.MapPointParticipationOverrides)
            {
                string line = "";
