...
namespace MapBuddy.EventInfo
{
    internal class InfoRetryPoint
    {
        ...
        string output_dir = "";
        string header = "";
        string combined_file_name = "global_retrypoint_info";
        string file_format = "csv";

        public InfoRetryPoint(string path)
        {
        ...
        public void Execute(bool splitByMap)
        {
            ...
            logger.AddToLog($"Written event information to {output_dir}");
            logger.WriteLog();
        }
