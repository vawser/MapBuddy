...
namespace MapBuddy.Info
{
    internal class InfoMapPiece
    {
        ...
        string output_dir = "";
        string header = "";
        string combined_file_name = "Global_MapPiece";
        string file_format = "csv";

        public InfoMapPiece(string path)
        {
        ...
        public void Execute(bool splitByMap)
        {
            ...
            logger.AddToLog($"Written MapPiece data to {output_dir}");
            logger.WriteLog();
        }
