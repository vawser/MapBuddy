...
namespace MapBuddy.Info
{
    internal class InfoDummyEnemy
    {
        ...
        string output_dir = "";
        string header = "";
        string combined_file_name = "Global_DummyEnemy";
        string file_format = "csv";

        public InfoDummyEnemy(string path)
        {
        ...
        public void Execute(bool splitByMap)
        {
            ...
            logger.AddToLog($"Written DummyEnemy data to {output_dir}");
            logger.WriteLog();
        }
        ...
        public void WriteCSV(MSBE msb, string map_name, bool outputByMap)
        {
            ...
            foreach (MSBE.Part.DummyEnemy enemy in msb.Parts.DummyEnemies)
            {
                string line = "";
